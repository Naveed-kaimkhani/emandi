...
//     await widget.billingRepository.addBill(billing);
//   }
...
//                     validator: (value) {
//                       if (value == null || value.isEmpty) {
//                         return AppLocalizations.of(context)!.itemRates;
//                       }
//                       return null;
//                     },
//                   ),
  ...
  void _generateBill() {
    if (_formKey.currentState!.validate() &&
      ...
      setState(() {
        ...
        Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => InvoiceScreen(bills: _items, name: _nameController.text)),
  );
      // _resetFields();
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
