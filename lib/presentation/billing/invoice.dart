...
class InvoiceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate values from the first item
    // Calculate total sum of all items
    final double total = bills.fold(
        0.0, (sum, bill) => sum + (bill.itemRates! * bill.itemCount));

    final firstBill = bills[0];
    final double commission = total * 0.10;
    final double rent = firstBill.rent;
    final int portrages = firstBill.portrages ?? 0;
                          ...
                          children: [
                            ...
                            TableRow(
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.all(8.0.w),
                                  child: Text(commission.toStringAsFixed(2),
                                      style: TextStyle(fontSize: 16.sp)),
                                ),
                              ],
                            ),
                            ...
                            TableRow(
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.all(8.0.w),
                                  child: Text(
                                    (total - commission - rent - portrages)
                                        .toString(),
                                    style: TextStyle(fontSize: 16.sp),
                                  ),
                                ),
          ...
          children: [
            AuthButton(
              ...
              func: () async {
                ...
                if (image != null) {
                  saveAndShareReceipt(image, isPrint: true);
                }
              },
