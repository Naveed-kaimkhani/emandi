...
class CreateBillForAUser extends StatefulWidget {
  ...
  const CreateBillForAUser(
      {super.key, required this.billingRepository, required this.name});
...
//         rent: double.parse(_rentController.text),
//       );
//       BlocProvider.of<ItemBloc>(context).add(AddItem(newItem));
//       BlocProvider.of<ItemBloc>(context).add(const GenerateBill());
//     } else {
//       utils.flushBarErrorMessage(
//           AppLocalizations.of(context)!.enterAllDetail, context);
//     }
...
//   Widget build(BuildContext context) {
//     return BlocProvider(
//       create: (context) => ItemBloc(billingRepository: getIt()),
...
//                           // Handle bill generation, like navigating to InvoiceScreen
